...
train_dataset_x = pd.read_csv('dataA_train_x.csv', index_col=0)
...
val_dataset_x = pd.read_csv('dataA_val_x.csv', index_col=0)
...
for j in range(3,5):
    ...
    y_test = pd.read_csv('dataA_test_y.csv', index_col=0)
